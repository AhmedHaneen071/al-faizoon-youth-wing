          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-3 mt-6">
              <a
                ...
                className="w-10 h-10 rounded-xl bg-emerald-600/20 text-emerald-400 flex items-center justify-center hover:bg-emerald-600/30 transition-colors"
                aria-label="WhatsApp"
              >
              ...
              <a
                ...
                className="w-10 h-10 rounded-xl bg-primary-600/20 text-primary-400 flex items-center justify-center hover:bg-primary-600/30 transition-colors"
                aria-label="Email"
              >
